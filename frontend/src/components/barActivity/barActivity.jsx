...
function BarActivity({ sessions }) {
     // Composant CustomTooltip pour afficher des informations personnalisées dans l'infobulle(tooltips)
     const CustomTooltip = ({ active, payload, label }) => {
          // Vérifie si l'infobulle est active et si elle a un payload
          if (active && payload && payload.length) {
               ...
               // Retourne le contenu de l'infobulle avec les données de poids et de calories
               return (
